...
const posts: Record<string, { title: string; content: string[]; date: string; readTime: string; category: string; author: string }> = {
  ...
  'how-ai-agents-cut-project-costs': {
    ...
    content: [
      ...
      'The most impactful single agent is the Planning Agent, which reduces scheduling conflicts and optimizes resource allocation in real time.',
    ],
  },
  'vision-agent-case-study': {
    ...
    content: [
      ...
      'The contractor reported a 73% reduction in safety incidents and a 40% reduction in time spent on safety inspections.',
    ],
  },
  'robotics-construction-2026': {
    ...
    content: [
      ...
      'The challenge is no longer the robots themselves, but coordinating them. That is where BuildOS Robot Orchestrator comes in.',
    ],
  },
  'ai-planning-vs-traditional': {
    ...
    content: [
      ...
      'The most impressive result: projects using AI schedules were 68% likely to finish on time, compared to 20% for human-only schedules.',
    ],
  },
  'supply-chain-ai-predictions': {
    ...
    content: [
      ...
      'Early warning means proactive mitigation: alternative suppliers, expedited shipping, or schedule adjustments before the delay impacts the critical path.',
    ],
  },
};
